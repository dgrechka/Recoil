!(function (global, factory) {
  ...
  function loadableWithPromise(promise) {
    return Object.freeze({
      ...
      ...loadableAccessors,
      getValue() {
        throw this.contents.then(({__value: __value}) => __value);
      },
      toPromise() {
        return this.contents.then(({__value: __value}) => __value);
      },
      promiseMaybe() {
        return this.contents.then(({__value: __value}) => __value);
      },
  ...
  const useMutableSource =
    null !== (_useMutableSource = react.useMutableSource) &&
    void 0 !== _useMutableSource
      ? _useMutableSource
  ...
  function Recoil_gkx(gk) {
    var _gks$get;
    return (
      !('recoil_early_rendering_2021' === gk && !mutableSourceExists$1()) &&
      null !== (_gks$get = gks.get(gk)) &&
      void 0 !== _gks$get &&
      _gks$get
    );
  }
  ...
  var Recoil_recoverableViolation = function (
    message,
    projectName,
    {error: error} = {},
  ) {
  ...
  var Recoil_filterIterable = function* (iterable, predicate) {
    let index = 0;
    for (const value of iterable) predicate(value, index++) && (yield value);
  };
  ...
  var Recoil_RecoilValue = {
    ...
    Recoil_RecoilValue$1 = Object.freeze({
      __proto__: null,
  ...
  var Recoil_Node = {
    ...
    deleteNodeConfigIfPossible: function (key) {
      var _node$shouldDeleteCon;
      if (!Recoil_gkx_1('recoil_memory_managament_2020')) return;
      const node = nodes.get(key);
      var _getConfigDeletionHan;
      (null == node ||
      null === (_node$shouldDeleteCon = node.shouldDeleteConfigOnRelease) ||
      void 0 === _node$shouldDeleteCon
        ? void 0
        : _node$shouldDeleteCon.call(node)) &&
        (nodes.delete(key),
        null === (_getConfigDeletionHan = getConfigDeletionHandler(key)) ||
          void 0 === _getConfigDeletionHan ||
          _getConfigDeletionHan(),
        configDeletionHandlers.delete(key));
    },
    setConfigDeletionHandler: function (key, fn) {
  ...
  const {setByAddingToSet: setByAddingToSet$1} = Recoil_CopyOnWrite,
    ...
    {RetentionZone: RetentionZone$1} = Recoil_RetentionZone,
  ...
  function initializeNodeIfNewToStore(store, treeState, key, trigger) {
    ...
    const config = getNode$1(key),
      retentionCleanup = (function (store, nodeKey, retainedBy) {
        if (!Recoil_gkx_1('recoil_memory_managament_2020')) return () => {};
        const {
          nodesRetainedByZone: nodesRetainedByZone,
        } = store.getState().retention;
        function addToZone(zone) {
          let set = nodesRetainedByZone.get(zone);
          set || nodesRetainedByZone.set(zone, (set = new Set())),
            set.add(nodeKey);
        }
        if (retainedBy instanceof RetentionZone$1) addToZone(retainedBy);
        else if (Array.isArray(retainedBy))
          for (const zone of retainedBy) addToZone(zone);
        return () => {
          if (!Recoil_gkx_1('recoil_memory_managament_2020')) return;
          ...
          function deleteFromZone(zone) {
            ...
            set && set.delete(nodeKey),
              set && 0 === set.size && nodesRetainedByZone.delete(zone);
          }
          if (retainedBy instanceof RetentionZone$1) deleteFromZone(retainedBy);
          else if (Array.isArray(retainedBy))
            for (const zone of retainedBy) deleteFromZone(zone);
        };
      })(store, key, config.retainedBy),
      nodeCleanup = config.init(store, treeState, trigger);
    storeState.nodeCleanupFunctions.set(key, () => {
      nodeCleanup(), retentionCleanup();
    });
  }
  ...
  var Recoil_FunctionalCore = {
    ...
    cleanUpNode: function (store, key) {
      ...
      null === (_state$nodeCleanupFun = state.nodeCleanupFunctions.get(key)) ||
        void 0 === _state$nodeCleanupFun ||
  ...
  const {CANCELED: CANCELED$1} = Recoil_Loadable,
    ...
    {getNodeMaybe: getNodeMaybe$2} = Recoil_Node,
    {
  ...
  function applyAction(store, state, action) {
    if ('set' === action.type) {
      const {recoilValue: recoilValue, valueOrUpdater: valueOrUpdater} = action,
        newValue = (function (store, state, {key: key}, valueOrUpdater) {
        ...
        })(store, state, recoilValue, valueOrUpdater),
        writes = setNodeValue$1(store, state, recoilValue.key, newValue);
  ...
  function writeLoadableToTreeState(state, key, loadable) {
    'hasValue' === loadable.state && loadable.contents instanceof DefaultValue$1
      ? state.atomValues.delete(key)
  ...
  function invalidateDownstreams(store, state) {
    ...
    for (const key of downstreams) {
      ...
      null === (_getNodeMaybe = getNodeMaybe$2(key)) ||
  ...
  var Recoil_RecoilValueInterface = {
    ...
    getRecoilValueAsLoadable: function (
      ...
      return (
        'loading' === loadable.state &&
          loadable.contents.catch(() => CANCELED$1),
        loadable
      );
    },
    ...
    subscribeToRecoilValue: function (
      store,
      {key: key},
      callback,
      ...
      if (
        ...
        nextTree && nextTree.dirtyAtoms.has(key) && callback(nextTree);
      }
      return {
        release: () => {
          const storeState = store.getState(),
  ...
  function mergeDependencyMapIntoGraph(deps, graph, olderGraph) {
    const {
      nodeDeps: nodeDeps,
        ...
        Recoil_differenceSets(existingUpstreams, upstreams).forEach(
          upstream => {
            ...
            existing.delete(downstream),
              0 === existing.size && nodeToNodeSubscriptions.delete(upstream);
          },
        );
      }
    });
  ...
  var Recoil_Graph = {
    ...
    mergeDepsIntoDependencyMap: function (from, into) {
      from.forEach((upstreamDeps, downstreamNode) => {
        into.has(downstreamNode) || into.set(downstreamNode, new Set());
    ...
    saveDependencyMapToStore: function (dependencyMap, store, version) {
      ...
      if (
        ...
        version ===
          (null === (_storeState$previousT2 = storeState.previousTree) ||
          void 0 === _storeState$previousT2
            ? void 0
            : _storeState$previousT2.version))
      ) {
        mergeDependencyMapIntoGraph(
          dependencyMap,
          store.getGraph(storeState.currentTree.version),
          graph,
        );
      }
      if (
        version ===
          (null === (_storeState$previousT3 = storeState.previousTree) ||
          void 0 === _storeState$previousT3
            ? void 0
        ...
        const nextVersion =
          null === (_storeState$nextTree2 = storeState.nextTree) ||
          void 0 === _storeState$nextTree2
            ? void 0
            : _storeState$nextTree2.version;
        if (void 0 !== nextVersion) {
          mergeDependencyMapIntoGraph(
            dependencyMap,
            store.getGraph(nextVersion),
            graph,
          );
        }
      }
  ...
  var hamt_1 = (function (fn, module) {
    ...
    var _typeof =
      ...
      hash = (hamt.hash = function (str) {
        var type = void 0 === str ? 'undefined' : _typeof(str);
        if ('number' === type) return str;
        'string' !== type && (str += '');
      ...
      empty = {__hamt_isEmpty: !0},
      isEmptyNode = function (x) {
        return x === empty || (x && x.__hamt_isEmpty);
      },
      Leaf = function (edit, hash, key, value) {
        return {
          type: 1,
          edit: edit,
          hash: hash,
      ...
      Collision = function (edit, hash, children) {
        return {
          type: 2,
          edit: edit,
          hash: hash,
      ...
      IndexedNode = function (edit, mask, children) {
        return {
          type: 3,
          edit: edit,
          mask: mask,
      ...
      ArrayNode = function (edit, size, children) {
        return {
          type: 4,
          edit: edit,
          size: size,
      ...
      mergeLeaves = function mergeLeaves(edit, shift, h1, n1, h2, n2) {
        ...
        return IndexedNode(
          ...
          subH1 === subH2
            ? [mergeLeaves(edit, shift + 5, h1, n1, h2, n2)]
            : subH1 < subH2
            ? [n1, n2]
            : [n2, n1],
        );
      },
      canEditNode = function (edit, node) {
        return edit === node.edit;
      },
      Leaf__modify = function (edit, keyEq, shift, f, h, k, size) {
        if (keyEq(k, this.key)) {
          var _v = f(this.value);
      ...
      Collision__modify = function (edit, keyEq, shift, f, h, k, size) {
        if (h === this.hash) {
          var list = (function (mutate, edit, keyEq, h, list, f, k, size) {
            for (var len = list.length, i = 0; i < len; ++i) {
              ...
              if (keyEq(k, child.key)) {
                ...
                return _newValue === value
                  ...
                  : arrayUpdate(mutate, i, Leaf(edit, h, k, _newValue), list);
              }
            }
            var newValue = f();
      ...
      IndexedNode__modify = function (edit, keyEq, shift, f, h, k, size) {
        var mask = this.mask,
          ...
          exists = mask & bit,
          current = exists ? children[indx] : empty,
          child = current._modify(edit, keyEq, shift + 5, f, h, k, size);
        if (current === child) return this;
        var node,
          canEdit = canEditNode(edit, this),
          bitmap = mask,
          newChildren = void 0;
        if (exists && isEmptyNode(child)) {
          if (!(bitmap &= ~bit)) return empty;
          if (
            children.length <= 2 &&
            ((node = children[1 ^ indx]) === empty ||
              1 === node.type ||
              2 === node.type)
          )
          ...
          if (children.length >= MAX_INDEX_NODE)
            return (function (edit, frag, child, bitmap, subNodes) {
              for (var arr = [], bit = bitmap, count = 0, i = 0; bit; ++i)
                1 & bit && (arr[i] = subNodes[count++]), (bit >>>= 1);
              return (arr[frag] = child), ArrayNode(edit, count + 1, arr);
            })(edit, frag, child, mask, children);
          (bitmap |= bit),
            (newChildren = (function (mutate, at, v, arr) {
              var len = arr.length;
              if (mutate) {
                for (var _i = len; _i >= at; ) arr[_i--] = arr[_i];
                return (arr[at] = v), arr;
              }
              for (var i = 0, g = 0, out = new Array(len + 1); i < at; )
                out[g++] = arr[i++];
              for (out[at] = v; i < len; ) out[++g] = arr[i++];
              return out;
            })(canEdit, indx, child, children));
        }
        return canEdit
          ? ((this.mask = bitmap), (this.children = newChildren), this)
          : IndexedNode(edit, bitmap, newChildren);
      },
      ArrayNode__modify = function (edit, keyEq, shift, f, h, k, size) {
        var count = this.size,
          children = this.children,
          frag = hashFragment(shift, h),
          child = children[frag],
          newChild = (child || empty)._modify(
            edit,
            keyEq,
            shift + 5,
            f,
        ...
        return canEdit
          ...
          : ArrayNode(edit, count, newChildren);
      };
    ...
    (empty._modify = function (edit, keyEq, shift, f, h, k, size) {
      var v = f();
      return v === nothing ? empty : (++size.value, Leaf(edit, h, k, v));
    }),
      (Map.prototype.setTree = function (newRoot, newSize) {
        return this._editable
          ? ((this._root = newRoot), (this._size = newSize), this)
          : newRoot === this._root
          ? this
          : new Map(this._editable, this._edit, this._config, newRoot, newSize);
      });
    var tryGetHash = (hamt.tryGetHash = function (alt, hash, key, map) {
      for (var node = map._root, shift = 0, keyEq = map._config.keyEq; ; )
        switch (node.type) {
          case 1:
          ...
          case 2:
            if (hash === node.hash)
              for (
                var children = node.children, i = 0, len = children.length;
                i < len;
                ++i
              ) {
          ...
          case 3:
            ...
            return alt;
          case 4:
            if ((node = node.children[hashFragment(shift, hash)])) {
              shift += 5;
              break;
            }
            return alt;
    ...
    var defKeyCompare = function (x, y) {
      return x === y;
    };
    ...
    var del = constant(nothing),
      removeHash = (hamt.removeHash = function (hash, key, map) {
    ...
    var endMutation = (hamt.endMutation = function (map) {
      return (map._editable = map._editable && map._editable - 1), map;
    });
    ...
    var appk = function (k) {
      ...
      lazyVisitChildren = function (len, children, i, f, k) {
        for (; i < len; ) {
          var child = children[i++];
    ...
    (MapIterator.prototype.next = function () {
      ...
      var v0 = this.v;
      return (this.v = appk(v0.rest)), v0;
    }),
      (MapIterator.prototype[Symbol.iterator] = function () {
        return this;
      });
    var visit = function (map, f) {
        return new MapIterator(lazyVisit(map._root, f));
      },
      buildPairs = function (x) {
        return [x.key, x.value];
      },
      entries = (hamt.entries = function (map) {
        return visit(map, buildPairs);
      });
    Map.prototype.entries = Map.prototype[Symbol.iterator] = function () {
      return entries(this);
    };
    var buildKeys = function (x) {
        return x.key;
      },
      keys = (hamt.keys = function (map) {
        return visit(map, buildKeys);
      });
    Map.prototype.keys = function () {
      return keys(this);
    };
    var buildValues = function (x) {
        return x.value;
      },
      values = (hamt.values = Map.prototype.values = function (map) {
    ...
    var fold = (hamt.fold = function (f, z, m) {
      var root = m._root;
      if (1 === root.type) return f(z, root.value, root.key);
      for (
        var toVisit = [root.children], children = void 0;
    ...
    (Map.prototype.count = function () {
      ...
      module.exports ? (module.exports = hamt) : ((void 0).hamt = hamt);
  });
  class BuiltInMap {
    constructor(existing) {
      _defineProperty(this, '_map', void 0),
        (this._map = new Map(null == existing ? void 0 : existing.entries()));
    }
    keys() {
    ...
    set(k, v) {
      return this._map.set(k, v), this;
    }
    delete(k) {
      return this._map.delete(k), this;
    }
    clone() {
  ...
  class HashArrayMappedTrieMap {
    constructor(existing) {
      if (
        ...
        existing instanceof HashArrayMappedTrieMap)
      ) {
        const h = existing._hamt.endMutation();
        (existing._hamt = h.beginMutation()), (this._hamt = h.beginMutation());
    ...
    set(k, v) {
      return this._hamt.set(k, v), this;
    }
    delete(k) {
      return this._hamt.delete(k), this;
    }
    clone() {
      return persistentMap(this);
    }
  ...
  function persistentMap(existing) {
    return Recoil_gkx_1('recoil_hamt_2020')
      ? new HashArrayMappedTrieMap(existing)
      : new BuiltInMap(existing);
  }
  var Recoil_PersistentMap_1 = persistentMap,
    Recoil_PersistentMap$1 = Object.freeze({
      __proto__: null,
      persistentMap: Recoil_PersistentMap_1,
    });
  const {graph: graph$1} = Recoil_Graph,
    {persistentMap: persistentMap$1} = Recoil_PersistentMap$1;
  ...
  var Recoil_someSet = function (set, callback, context) {
    const iterator = set.entries();
    let current = iterator.next();
    for (; !current.done; ) {
      const entry = current.value;
      if (callback.call(context, entry[1], entry[0], set)) return !0;
  ...
  const {cleanUpNode: cleanUpNode$1} = Recoil_FunctionalCore,
    ...
    {RetentionZone: RetentionZone$2} = Recoil_RetentionZone,
    emptySet$1 = new Set();
  function releaseRetainablesNowOnCurrentTree(store, retainables) {
    const storeState = store.getState(),
      treeState = storeState.currentTree;
    if (storeState.nextTree) return;
    const nodes = new Set();
    for (const r of retainables)
      if (r instanceof RetentionZone$2)
        for (const n of nodesRetainedByZone(storeState, r)) nodes.add(n);
      else nodes.add(r);
    const releasableNodes = (function (store, searchFromNodes) {
      const storeState = store.getState(),
        treeState = storeState.currentTree,
        graph = store.getGraph(treeState.version),
        releasableNodes = new Set(),
        nonReleasableNodes = new Set();
      return findReleasableNodesInner(searchFromNodes), releasableNodes;
      function findReleasableNodesInner(searchFromNodes) {
        const releasableNodesFoundThisIteration = new Set(),
          downstreams = (function (
            ...
            function visit(node) {
              ...
              visited.add(node), nodes.delete(node), answer.push(node);
            }
          })(
            store,
            treeState,
        ...
        for (const node of downstreams) {
          ...
          if ('recoilRoot' === getNode$2(node).retainedBy) {
        ...
        for (const node of releasableNodesFoundThisIteration)
          for (const parent of null !==
            (_graph$nodeDeps$get = graph.nodeDeps.get(node)) &&
          void 0 !== _graph$nodeDeps$get
            ? _graph$nodeDeps$get
            : emptySet$1) {
            var _graph$nodeDeps$get;
            releasableNodes.has(parent) || parents.add(parent);
          }
        parents.size && findReleasableNodesInner(parents);
      }
    })(store, nodes);
  ...
  function nodesRetainedByZone(storeState, zone) {
    ...
    return null !==
      (_storeState$retention3 = storeState.retention.nodesRetainedByZone.get(
        zone,
      )) && void 0 !== _storeState$retention3
      ? _storeState$retention3
      : emptySet$1;
  }
  function zonesThatCouldRetainNode(node) {
    const retainedBy = getNode$2(node).retainedBy;
    return void 0 === retainedBy ||
      'components' === retainedBy ||
      'recoilRoot' === retainedBy
      ? []
      : retainedBy instanceof RetentionZone$2
      ? [retainedBy]
      : retainedBy;
  }
  ...
  var Recoil_Retention = {
    updateRetainCount: function (store, retainable, delta) {
      var _map$get;
      if (!Recoil_gkx_1('recoil_memory_managament_2020')) return;
      const map = store.getState().retention.referenceCounts,
        newCount =
          (null !== (_map$get = map.get(retainable)) && void 0 !== _map$get
            ? _map$get
            : 0) + delta;
      0 === newCount
    ...
    releaseScheduledRetainablesNow: function (store) {
      if (!Recoil_gkx_1('recoil_memory_managament_2020')) return;
      const state = store.getState();
    ...
    retainedByOptionWithDefault: function (r) {
      return void 0 === r ? 'recoilRoot' : r;
    },
  };
  var Recoil_concatIterables = function* (iters) {
  ...
  const {isSSR: isSSR$1} = Recoil_Environment,
    {batchUpdates: batchUpdates$1} = Recoil_Batching,
    {
      initializeNodeIfNewToStore: initializeNodeIfNewToStore$1,
      peekNodeInfo: peekNodeInfo$1,
    } = Recoil_FunctionalCore,
    {graph: graph$2} = Recoil_Graph,
    {
  ...
  class Snapshot {
    constructor(storeState) {
      _defineProperty(this, '_store', void 0),
        ...
        _defineProperty(this, 'getNodes_UNSTABLE', opt => {
          if (
            (this.checkRefCount_INTERNAL(),
            !0 === (null == opt ? void 0 : opt.isModified))
          ) {
          ...
          const knownAtoms = this._store.getState().knownAtoms,
            knownSelectors = this._store.getState().knownSelectors;
    ...
    retain() {
      ...
      let released = !1;
      return () => {
        released || ((released = !0), this.release_INTERNAL());
      };
    }
    autorelease_INTERNAL() {
      Recoil_gkx_1('recoil_memory_managament_2020') &&
        (isSSR$1 || window.setTimeout(() => this.release_INTERNAL(), 0));
    }
    release_INTERNAL() {
      Recoil_gkx_1('recoil_memory_managament_2020') &&
    ...
    checkRefCount_INTERNAL() {
      Recoil_gkx_1('recoil_memory_managament_2020') && this._refCount;
    }
    getStore_INTERNAL() {
  ...
  function cloneStoreState(store, treeState, bumpVersion = !1) {
    const storeState = store.getState(),
  ...
  var Recoil_Snapshot = {
      ...
      freshSnapshot: function (initializeState) {
        ...
        return null != initializeState
          ? snapshot.map(initializeState)
          : snapshot;
      },
    ...
    Recoil_Snapshot$1 = Object.freeze({
      __proto__: null,
  ...
  const {
    ...
    {freshSnapshot: freshSnapshot$1} = Recoil_Snapshot$1,
    {
  ...
  let stateReplacerIsBeingExecuted = !1;
  function startNextTreeIfNeeded(store) {
    ...
    if (null === storeState.nextTree) {
      Recoil_gkx_1('recoil_memory_managament_2020') &&
        ...
        storeState.commitDepth > 0 &&
        releaseScheduledRetainablesNow$1(store);
      const version = storeState.currentTree.version,
        nextVersion = getNextTreeStateVersion$2();
      (storeState.nextTree = {
        ...storeState.currentTree,
        version: nextVersion,
        stateID: nextVersion,
    ...
    if (dirtyAtoms.size) {
      for (const [
        ...
        if (dirtyAtoms.has(key))
          for (const [_, subscription] of subscriptions) subscription(store);
  ...
  function endBatch(storeRef) {
    ...
    try {
      const {nextTree: nextTree} = storeState;
      if (null === nextTree) return;
      (storeState.previousTree = storeState.currentTree),
        (storeState.currentTree = nextTree),
        (storeState.nextTree = null),
        sendEndOfBatchNotifications(storeRef.current),
        null != storeState.previousTree
  ...
  function Batcher({setNotifyBatcherOfChange: setNotifyBatcherOfChange}) {
  ...
  function RecoilRoot_INTERNAL({
    ...
    const notifyBatcherOfChange = useRef(null),
      setNotifyBatcherOfChange = useCallback(
        x => {
              ...
              initializeState({
                set: (atom, value) => {
                  const state = initial.currentTree,
                    writes = setNodeValue$2(store, state, atom.key, value),
  ...
  var Recoil_RecoilRoot_react = {
    ...
    useRecoilFlushBatchedUpdates: function () {
      const storeRef = useStoreRef();
      return useCallback(() => {
        endBatch(storeRef);
      }, [storeRef]);
    },
    RecoilRoot: function (props) {
      const {override: override, ...propsExceptOverride} = props,
        ancestorStoreRef = useStoreRef();
      return !1 === override && ancestorStoreRef.current !== defaultStore
        ? props.children
        : react.createElement(RecoilRoot_INTERNAL, propsExceptOverride);
    },
    notifyComponents_FOR_TESTING: notifyComponents,
    sendEndOfBatchNotifications_FOR_TESTING: sendEndOfBatchNotifications,
  };
  const {loadableWithValue: loadableWithValue$1} = Recoil_Loadable,
    {DEFAULT_VALUE: DEFAULT_VALUE$2, getNode: getNode$3} = Recoil_Node,
    {
  ...
  function isAtom(recoilValue) {
    return 'atom' === getNode$3(recoilValue.key).nodeType;
  }
  class TransactionInterfaceImpl {
    constructor(store, treeState) {
      _defineProperty(this, '_store', void 0),
        ...
        _defineProperty(this, 'set', (recoilState, valueOrUpdater) => {
          ...
          } else this._changes.set(recoilState.key, valueOrUpdater);
        }),
        _defineProperty(this, 'reset', recoilState => {
    ...
    newTreeState_INTERNAL() {
      ...
      return invalidateDownstreams$1(this._store, newState), newState;
    }
  }
  var Recoil_AtomicUpdates_1 = function (store) {
      return fn => {
        store.replaceState(treeState => {
          const changeset = new TransactionInterfaceImpl(store, treeState);
          return fn(changeset), changeset.newTreeState_INTERNAL();
        });
      };
    },
    Recoil_AtomicUpdates$1 = Object.freeze({
      __proto__: null,
  ...
  var Recoil_filterSet = function (set, callback) {
    const result = new Set();
    for (const value of set) callback(value) && result.add(value);
    return result;
  };
  ...
  var Recoil_shallowArrayEqual = function (a, b) {
    if (a === b) return !0;
  ...
  var Recoil_useComponentName = function () {
    return useRef$1(), '<component name not available>';
  };
  const {atomicUpdater: atomicUpdater$1} = Recoil_AtomicUpdates$1,
    {batchUpdates: batchUpdates$2} = Recoil_Batching,
    {
    ...
    {updateRetainCount: updateRetainCount$2} = Recoil_Retention,
    {RetentionZone: RetentionZone$3} = Recoil_RetentionZone,
    {Snapshot: Snapshot$1, cloneSnapshot: cloneSnapshot$1} = Recoil_Snapshot$1,
    {setByAddingToSet: setByAddingToSet$2} = Recoil_CopyOnWrite,
    {isSSR: isSSR$2} = Recoil_Environment,
    {
  ...
  function useRecoilValueLoadable(recoilValue) {
    return (
      Recoil_gkx_1('recoil_memory_managament_2020') && useRetain(recoilValue),
      mutableSourceExists$2()
        ? (function (recoilValue) {
            const storeRef = useStoreRef$1(),
              getLoadable = useCallback$1(() => {
                var _storeState$nextTree2;
              ...
              getLoadableWithTesting = useCallback$1(() => getLoadable(), [
                getLoadable,
              ]),
              componentName = Recoil_useComponentName(),
              subscribe = useCallback$1(
              ...
              loadable = useMutableSource$1(
                source,
                getLoadableWithTesting,
                subscribe,
              ),
              prevLoadableRef = useRef$2(loadable);
            return (
              useEffect$1(() => {
        ...
        : (function (recoilValue) {
            ...
            useEffect$1(() => {
              ...
              if (storeState.nextTree)
                ...
                (null === (_prevLoadableRef$curr2 = prevLoadableRef.current) ||
                void 0 === _prevLoadableRef$curr2
                  ? void 0
  ...
  function useGotoRecoilSnapshot() {
    ...
    return useCallback$1(
      snapshot => {
        ...
        const storeState = storeRef.current.getState(),
          prev =
            null !== (_storeState$nextTree3 = storeState.nextTree) &&
            void 0 !== _storeState$nextTree3
  ...
  function useRetain(toRetain) {
    if (Recoil_gkx_1('recoil_memory_managament_2020'))
      return (function (toRetain) {
        const retainables = (Array.isArray(toRetain)
            ? toRetain
            : [toRetain]
          ).map(a => (a instanceof RetentionZone$3 ? a : a.key)),
          storeRef = useStoreRef$1();
        useEffect$1(() => {
          if (!Recoil_gkx_1('recoil_memory_managament_2020')) return;
          const store = storeRef.current;
          if (timeoutID.current && !isSSR$2)
            window.clearTimeout(timeoutID.current), (timeoutID.current = null);
        ...
        const timeoutID = useRef$2(),
          previousRetainables = usePrevious(retainables);
        if (
          !(
            isSSR$2 ||
            (void 0 !== previousRetainables &&
  ...
  var Recoil_Hooks = {
        ...
        (...args) => {
          ...
          return (
            batchUpdates$2(() => {
              ...
              if ('function' != typeof cb) throw new Error(errMsg);
              ret = cb(...args);
            }),
    ...
    useRecoilInterface: function () {
      const storeRef = useStoreRef$1(),
        [_, forceUpdate] = useState$1([]),
        recoilValuesUsed = useRef$2(new Set());
      recoilValuesUsed.current = new Set();
      const previousSubscriptions = useRef$2(new Set()),
        subscriptions = useRef$2(new Map()),
        unsubscribeFrom = useCallback$1(
          key => {
    ...
    useRecoilSnapshot: function () {
      const storeRef = useStoreRef$1(),
        ...
        previousSnapshot = usePrevious(snapshot),
        timeoutID = useRef$2();
      return (
        useEffect$1(
          () => (
        ...
        previousSnapshot === snapshot ||
          isSSR$2 ||
          (timeoutID.current &&
            (null == previousSnapshot || previousSnapshot.release_INTERNAL(),
            window.clearTimeout(timeoutID.current)),
          snapshot.retain(),
          (timeoutID.current = window.setTimeout(() => {
            snapshot.release_INTERNAL(), (timeoutID.current = null);
          }, 12e4))),
        snapshot
      );
    },
    ...
    useRecoilTransaction: function (fn, deps) {
      const storeRef = useStoreRef$1();
      return useMemo$1(
        () => (...args) => {
          atomicUpdater$1(storeRef.current)(transactionInterface => {
      ...
      useTransactionSubscription(
        useCallback$1(
          store => {
            ...
            callback({snapshot: snapshot, previousSnapshot: previousSnapshot});
          },
          [callback],
        ),
      );
      ...
      useTransactionSubscription(
        useCallback$1(
          store => {
            ...
            previousTree || (previousTree = store.getState().currentTree);
            const atomValues = externallyVisibleAtomValuesInState(currentTree),
              ...
              modifiedAtoms = Recoil_filterSet(
  ...
  const {peekNodeInfo: peekNodeInfo$2} = Recoil_FunctionalCore,
    {useStoreRef: useStoreRef$2} = Recoil_RecoilRoot_react;
  ...
  var Recoil_stableStringify = function (x, opt = {allowFunctions: !1}) {
    return (function stringify(x, opt, key) {
      ...
      return x instanceof Set
        ...
        : void 0 !== Symbol &&
          null != x[Symbol.iterator] &&
          'function' == typeof x[Symbol.iterator]
  ...
  const findLeaf = (root, getNodeValue, handlers) => {
      ...
      if (
        (null == handlers ||
          null === (_handlers$onNodeVisit = handlers.onNodeVisit) ||
          void 0 === _handlers$onNodeVisit ||
    ...
    addLeaf = (root, route, parent, value, branchKey, handlers) => {
      ...
      else if (((node = root), route.length)) {
        const [path, ...rest] = route,
          [nodeKey, nodeValue] = path;
        ('branch' !== root.type || root.nodeKey !== nodeKey) &&
          Recoil_invariant(!1),
          root.branches.set(
            nodeValue,
            addLeaf(
      ...
      return (
        null == handlers ||
          null === (_handlers$onNodeVisit2 = handlers.onNodeVisit) ||
          void 0 === _handlers$onNodeVisit2 ||
          _handlers$onNodeVisit2.call(handlers, node),
        node
      );
    },
    pruneNodeFromTree = (root, node, parent) =>
      parent
        ? (parent.branches.delete(node.branchKey),
          pruneUpstreamBranches(root, parent, parent.parent))
        : root === node,
    pruneUpstreamBranches = (root, branchNode, parent) =>
      parent
        ? (0 === branchNode.branches.size &&
            parent.branches.delete(branchNode.branchKey),
          pruneUpstreamBranches(root, parent, parent.parent))
        : root === branchNode,
    countDownstreamLeaves = node =>
      'leaf' === node.type
        ? 1
  ...
  var Recoil_TreeCache_1 = class {
      constructor(options) {
        ...
        _defineProperty(this, '_numLeafs', void 0),
          ...
          (this._onHit =
            null !==
              (_options$onHit = null == options ? void 0 : options.onHit) &&
            void 0 !== _options$onHit
              ? _options$onHit
              : () => {}),
          (this._onSet =
            null !==
              (_options$onSet = null == options ? void 0 : options.onSet) &&
            void 0 !== _options$onSet
              ? _options$onSet
              : () => {}),
          (this._mapNodeValue =
            null !==
              (_options$mapNodeValue =
                null == options ? void 0 : options.mapNodeValue) &&
            void 0 !== _options$mapNodeValue
              ? _options$mapNodeValue
              : val => val);
      }
      size() {
      ...
      get(getNodeValue, handlers) {
        ...
        return null ===
          (_this$getLeafNode = this.getLeafNode(getNodeValue, handlers)) ||
      ...
      getLeafNode(getNodeValue, handlers) {
        return findLeaf(
          ...
          {
            onNodeVisit: node => {
              null == handlers || handlers.onNodeVisit(node),
                'leaf' === node.type && this._onHit(node);
            },
          },
        );
      }
      set(route, value, handlers) {
        ...
        const newRoot = addLeaf(
          ...
          null,
          {
            onNodeVisit: node => {
              null == handlers || handlers.onNodeVisit(node),
                'leaf' === node.type && (leafNode = node);
            },
          },
        );
        this.root() || (this._root = newRoot),
          this._numLeafs++,
      ...
      delete(node) {
        ...
        return (
          !!pruneNodeFromTree(root, node, node.parent) &&
          (node === root || ('branch' === root.type && !root.branches.size)
            ? ((this._root = null), (this._numLeafs = 0), !0)
            : ((this._numLeafs -= countDownstreamLeaves(node)), !0))
        );
      }
      clear() {
    ...
    Recoil_TreeCache$1 = Object.freeze({
      __proto__: null,
      TreeCache: Recoil_TreeCache_1,
    });
  var Recoil_LRUCache_1 = class {
      constructor(options) {
        var _options$mapKey;
        _defineProperty(this, '_maxSize', void 0),
          ...
          (this._map = new Map()),
          (this._keyMapper =
            null !== (_options$mapKey = options.mapKey) &&
            void 0 !== _options$mapKey
              ? _options$mapKey
              : v => v);
      }
      head() {
      ...
      get(key) {
        const mappedKey = this._keyMapper(key),
          node = this._map.get(mappedKey);
        if (node) return this.set(key, node.value), node.value;
      }
      set(key, val) {
        const mappedKey = this._keyMapper(key);
        this._map.get(mappedKey) && this.delete(key);
        const head = this.head(),
          node = {key: key, right: head, left: null, value: val};
        head ? (head.left = node) : (this._tail = node),
      ...
      delete(key) {
        ...
        const node = Recoil_nullthrows(this._map.get(mappedKey)),
          right = node.right,
          left = node.left;
        right && (right.left = node.left),
          left && (left.right = node.right),
          node === this.head() && (this._head = right),
          node === this.tail() && (this._tail = left),
    ...
    Recoil_LRUCache$1 = Object.freeze({
      __proto__: null,
      LRUCache: Recoil_LRUCache_1,
    });
  const {LRUCache: LRUCache$1} = Recoil_LRUCache$1,
    {TreeCache: TreeCache$1} = Recoil_TreeCache$1;
  var Recoil_treeCacheLRU = function (maxSize, mapNodeValue = v => v) {
    const lruCache = new LRUCache$1({maxSize: maxSize}),
      cache = new TreeCache$1({
        ...
        onSet: node => {
          ...
          lruCache.set(node, !0),
            lruNode && cache.size() > maxSize && cache.delete(lruNode.key);
        },
      });
    return cache;
  };
  const {TreeCache: TreeCache$2} = Recoil_TreeCache$1,
    defaultPolicy = {equality: 'reference', eviction: 'none', maxSize: 1 / 0};
  var Recoil_treeCacheFromPolicy = function ({
    equality: equality = defaultPolicy.equality,
    eviction: eviction = defaultPolicy.eviction,
    maxSize: maxSize = defaultPolicy.maxSize,
  } = defaultPolicy) {
    return (function (eviction, maxSize, mapNodeValue) {
      switch (eviction) {
        case 'none':
          return new TreeCache$2({mapNodeValue: mapNodeValue});
        case 'lru':
  ...
  const {
    ...
    {isRecoilValue: isRecoilValue$2} = Recoil_RecoilValue$1,
    {AbstractRecoilValue: AbstractRecoilValue$4} = Recoil_RecoilValue$1,
    {
    ...
    {cloneSnapshot: cloneSnapshot$2} = Recoil_Snapshot$1,
  ...
  var Recoil_selector = function (options) {
    const {key: key, get: get, cachePolicy_UNSTABLE: cachePolicy} = options,
      set = null != options.set ? options.set : void 0,
      cache = Recoil_treeCacheFromPolicy(
        null != cachePolicy
          ? cachePolicy
          : {equality: 'reference', eviction: 'none'},
      ),
      retainedBy = retainedByOptionWithDefault$1(options.retainedBy_UNSTABLE),
    ...
    function selectorShouldDeleteConfigOnRelease() {
      return void 0 !== getConfigDeletionHandler$1(key) && !selectorIsLive();
    }
    ...
    function wrapPendingDependencyPromise(
      ...
      return promise
        .then(resolvedDep => {
          if (!selectorIsLive())
            return clearExecutionInfo(store, executionId), CANCELED$2;
          if (resolvedDep instanceof Canceled$1) return CANCELED$2;
          const {__key: resolvedDepKey, __value: depValue} =
            null != resolvedDep ? resolvedDep : {};
          let bypassSelectorDepCacheOnReevaluation = !0;
          null != resolvedDepKey &&
            (state.atomValues.set(
              resolvedDepKey,
              loadableWithValue$2(depValue),
            ),
            (bypassSelectorDepCacheOnReevaluation = !1));
          const cachedLoadable = getValFromCacheAndUpdatedDownstreamDeps(
            store,
            state,
          );
          if (cachedLoadable && 'hasValue' === cachedLoadable.state)
            return (
              setExecutionInfo(cachedLoadable, store),
              {__value: cachedLoadable.contents, __key: key}
            );
    ...
    function evaluateSelectorGetter(
      ...
      function getRecoilValue(recoilValue) {
        ...
        !(function (store, state, deps, newDepKey, executionId) {
          deps.add(newDepKey), setDepsInStore(store, state, deps, executionId);
        })(store, state, deps, depKey, executionId);
      ...
      try {
        (result = get({get: getRecoilValue, getCallback: getCallback})),
          (result = isRecoilValue$2(result) ? getRecoilValue(result) : result),
          (gateCallback = !0),
          Recoil_isPromise(result)
            ? (result = (function (
                store,
                promise,
                state,
                ...
                return promise
                  ...
                  .catch(errorOrPromise => {
                    ...
                    if (
                      ...
                      Recoil_isPromise(errorOrPromise))
                    )
        ...
        (result = errorOrDepPromise),
          Recoil_isPromise(result)
            ...
            : ((resultIsError = !0), endPerfBlock());
      }
      return (
        (loadable = resultIsError
          ? loadableWithError$1(result)
          : Recoil_isPromise(result)
          ? loadableWithPromise$1(result)
          : loadableWithValue$2(result)),
        maybeFreezeLoadableContents(loadable),
        [loadable, depValues]
      );
    }
    function getValFromCacheAndUpdatedDownstreamDeps(store, state) {
      const depsAfterCacheDone = new Set(),
        ...
        cachedVal = cache.get(
          nodeKey => {
            'string' != typeof nodeKey && Recoil_invariant(!1);
    ...
    function getValFromRunningNewExecutionAndUpdatedDeps(store, state) {
      const newExecutionId = getNewExecutionId(),
        [loadable, newDepValues] = evaluateSelectorGetter(
          store,
          state,
          newExecutionId,
        );
    ...
    function getSelectorValAndUpdatedDeps(store, state) {
      ...
      const inProgressExecutionInfo = (function (store, state) {
              ...
              ([, executionInfo]) =>
                ...
                !(function (store, state) {
                  ...
                  const executionInfo = getExecutionInfo(store),
                    ...
                    isCachedVersionSame =
                      ...
                      cachedDepValuesCheckedForThisVersion.length ===
                        oldDepValues.size &&
                      cachedDepValuesCheckedForThisVersion.every(
                        ([nodeKey, nodeVal]) =>
                          oldDepValues.get(nodeKey) === nodeVal,
                      );
                  if (
                    null == oldDepValues ||
                  ...
                  return (
                    ...
                    Array.from(oldDepValues).some(([nodeKey, oldVal]) => {
                      const loadable = getCachedNodeLoadable(
                        store,
                        state,
                        nodeKey,
                      );
    ...
    function clearExecutionInfo(store, executionId) {
      isLatestExecution(store, executionId) && executionInfoMap.delete(store);
    }
    ...
    if (null != set) {
      return registerNode$1({
        ...
        set: (store, state, newValue) => {
          ...
          return (syncSelectorSetFinished = !0), writes;
        },
        init: selectorInit,
  ...
  const {
    ...
    {isRecoilValue: isRecoilValue$3} = Recoil_RecoilValue$1,
    {
  ...
  function baseAtom(options) {
    const {key: key, persistence_UNSTABLE: persistence} = options,
      retainedBy = retainedByOptionWithDefault$2(options.retainedBy_UNSTABLE);
    let liveStoresCount = 0,
      defaultLoadable = Recoil_isPromise(options.default)
        ? loadableWithPromise$2(
            options.default
              .then(value => {
                defaultLoadable = loadableWithValue$3(value);
                return {__key: key, __value: value};
              })
              .catch(error => {
                throw ((defaultLoadable = loadableWithError$2(error)), error);
              }),
          )
    ...
    const node = registerNode$2({
      ...
      set: function (_store, state, newValue) {
        if (state.atomValues.has(key)) {
        ...
        return (
          (cachedAnswerForUnvalidatedValue = void 0),
          new Map().set(key, loadableWithValue$3(newValue))
        );
      },
      init: function (store, initState, trigger) {
        liveStoresCount++;
        ...
        let initValue = DEFAULT_VALUE$5,
          pendingSetSelf = null;
        if (null != options.effects_UNSTABLE && !alreadyKnown) {
          let duringInit = !0;
          const setSelf = effect => valueOrUpdater => {
              if (duringInit) {
                ...
                (initValue =
                  'function' == typeof valueOrUpdater
                    ...
                    : valueOrUpdater),
                  Recoil_isPromise(initValue) &&
                    (initValue = initValue.then(
                      value => (
                        (pendingSetSelf = {effect: effect, value: value}), value
                      ),
                    ));
              } else {
            ...
            resetSelf = effect => () => setSelf(effect)(DEFAULT_VALUE$5),
            onSet = effect => handler => {
              store.subscribeToTransactions(currentStore => {
                ...
                previousTree || (previousTree = currentTree);
                const newLoadable =
                  null !==
                    (_currentTree$atomValu = currentTree.atomValues.get(key)) &&
                  void 0 !== _currentTree$atomValu
                    ? _currentTree$atomValu
                    : defaultLoadable;
                if ('hasValue' === newLoadable.state) {
        ...
        if (!(initValue instanceof DefaultValue$2)) {
          ...
          const initLoadable = Recoil_isPromise(initValue)
            ? loadableWithPromise$2(
        ...
        return () => {
          ...
          liveStoresCount--,
            null ===
              (_cleanupEffectsByStor = cleanupEffectsByStore.get(store)) ||
      ...
      shouldDeleteConfigOnRelease: function () {
        return (
          void 0 !== getConfigDeletionHandler$2(key) && liveStoresCount <= 0
        );
      },
      dangerouslyAllowMutability: options.dangerouslyAllowMutability,
  ...
  function atom(options) {
    ...
    return isRecoilValue$3(optionsDefault)
                  ...
                  : {
                      ...
                      validator: storedValue =>
                        storedValue instanceof DefaultValue$2
                          ...
                          : Recoil_nullthrows(
                              options.persistence_UNSTABLE,
                            ).validator(storedValue, DEFAULT_VALUE$5),
                    },
      ...
      : baseAtom({...restOptions, default: optionsDefault});
  }
  var Recoil_atom = atom;
  var Recoil_MapCache_1 = class {
      constructor(options) {
        var _options$mapKey;
        _defineProperty(this, '_map', void 0),
          _defineProperty(this, '_keyMapper', void 0),
          ...
          (this._keyMapper =
            null !==
              (_options$mapKey = null == options ? void 0 : options.mapKey) &&
            void 0 !== _options$mapKey
              ? _options$mapKey
              : v => v);
      }
    ...
    Recoil_MapCache$1 = Object.freeze({
      __proto__: null,
      MapCache: Recoil_MapCache_1,
    });
  const {LRUCache: LRUCache$2} = Recoil_LRUCache$1,
    {MapCache: MapCache$1} = Recoil_MapCache$1,
    defaultPolicy$1 = {equality: 'reference', eviction: 'none', maxSize: 1 / 0};
  var Recoil_cacheFromPolicy = function ({
    equality: equality = defaultPolicy$1.equality,
    eviction: eviction = defaultPolicy$1.eviction,
    maxSize: maxSize = defaultPolicy$1.maxSize,
  } = defaultPolicy$1) {
    return (function (eviction, maxSize, mapKey) {
      switch (eviction) {
        case 'none':
          return new MapCache$1({mapKey: mapKey});
        case 'lru':
  ...
  var Recoil_atomFamily = function (options) {
      ...
      equality:
        null !==
          (_options$cachePolicyF =
            null ===
              (_options$cachePolicyF2 =
                options.cachePolicyForParams_UNSTABLE) ||
            void 0 === _options$cachePolicyF2
              ? void 0
              : _options$cachePolicyF2.equality) &&
        void 0 !== _options$cachePolicyF
          ? _options$cachePolicyF
          : 'value',
      eviction: 'none',
    });
    return params => {
      ...
      const {
          cachePolicyForParams_UNSTABLE: cachePolicyForParams_UNSTABLE,
          ...atomOptions
        } = options,
        newAtom = Recoil_atom({
          ...atomOptions,
          ...
          default:
            'function' == typeof options.default
              ? options.default(params)
              : options.default,
          retainedBy_UNSTABLE:
            'function' == typeof options.retainedBy_UNSTABLE
  ...
  var Recoil_selectorFamily = function (options) {
    ...
    return params => {
      ...
      const myKey = `${options.key}__selectorFamily/${
        ...
        myCachePolicy = options.cachePolicy_UNSTABLE,
        retainedBy =
          'function' == typeof options.retainedBy_UNSTABLE
            ? options.retainedBy_UNSTABLE(params)
            : options.retainedBy_UNSTABLE;
  ...
  var Recoil_WaitFor = {
    ...
    waitForAny: Recoil_selectorFamily({
      ...
      get: dependencies => ({get: get}) => {
        const deps = unwrapDependencies(dependencies),
          [results, exceptions] = concurrentRequests(get, deps);
        return exceptions.some(exp => !Recoil_isPromise(exp))
      ...
      get: dependencies => ({get: get}) => {
        ...
        return Promise.all(exceptions).then(exceptionResults => {
          return wrapResults(
            ...
            asyncResults.map((result, idx) =>
              void 0 === result ? syncResults[idx] : result,
    ...
    waitForAllSettled: Recoil_selectorFamily({
      ...
      get: dependencies => ({get: get}) => {
        const deps = unwrapDependencies(dependencies),
          [results, exceptions] = concurrentRequests(get, deps);
        return exceptions.every(exp => !Recoil_isPromise(exp))
          ? wrapLoadables(dependencies, results, exceptions)
          : Promise.all(
              exceptions.map((exp, i) =>
                Recoil_isPromise(exp)
                  ? exp
                      ...
                      .catch(error => {
                        (results[i] = void 0), (exceptions[i] = error);
                      })
                  : null,
              ),
  ...
  const {
    ...
    {isRecoilValue: isRecoilValue$4} = Recoil_RecoilValue$1,
    {retentionZone: retentionZone$1} = Recoil_RetentionZone,
    {freshSnapshot: freshSnapshot$2} = Recoil_Snapshot$1,
    {
  ...
  var Recoil_index = {
    ...
    Recoil_index_3 = Recoil_index.useRecoilBridgeAcrossReactRoots_UNSTABLE,
    Recoil_index_4 = Recoil_index.atom,
    Recoil_index_5 = Recoil_index.selector,
    Recoil_index_6 = Recoil_index.retentionZone,
    Recoil_index_7 = Recoil_index.atomFamily,
    Recoil_index_8 = Recoil_index.selectorFamily,
    Recoil_index_9 = Recoil_index.constSelector,
    Recoil_index_10 = Recoil_index.errorSelector,
    Recoil_index_11 = Recoil_index.readOnlySelector,
    Recoil_index_12 = Recoil_index.useRecoilValue,
    Recoil_index_13 = Recoil_index.useRecoilValueLoadable,
    Recoil_index_14 = Recoil_index.useRecoilState,
    Recoil_index_15 = Recoil_index.useRecoilStateLoadable,
    Recoil_index_16 = Recoil_index.useSetRecoilState,
    Recoil_index_17 = Recoil_index.useResetRecoilState,
    Recoil_index_18 = Recoil_index.useGetRecoilValueInfo_UNSTABLE,
    Recoil_index_19 = Recoil_index.useRetain,
    Recoil_index_20 = Recoil_index.useRecoilCallback,
    Recoil_index_21 = Recoil_index.useRecoilTransaction_UNSTABLE,
    Recoil_index_22 = Recoil_index.useRecoilFlushBatchedUpdates,
    Recoil_index_23 = Recoil_index.useGotoRecoilSnapshot,
    Recoil_index_24 = Recoil_index.useRecoilSnapshot,
    Recoil_index_25 = Recoil_index.useRecoilTransactionObserver_UNSTABLE,
    Recoil_index_26 = Recoil_index.useTransactionObservation_UNSTABLE,
    Recoil_index_27 = Recoil_index.useSetUnvalidatedAtomValues_UNSTABLE,
    Recoil_index_28 = Recoil_index.noWait,
    Recoil_index_29 = Recoil_index.waitForNone,
    Recoil_index_30 = Recoil_index.waitForAny,
    Recoil_index_31 = Recoil_index.waitForAll,
    Recoil_index_32 = Recoil_index.waitForAllSettled,
    Recoil_index_33 = Recoil_index.isRecoilValue,
    Recoil_index_34 = Recoil_index.batchUpdates,
    Recoil_index_35 = Recoil_index.setBatcher,
    Recoil_index_36 = Recoil_index.snapshot_UNSTABLE;
